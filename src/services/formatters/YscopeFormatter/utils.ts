...
const getFormattedField = (
    ...
    if (null !== mergedKvPairKeys) {
        const mergedKvPairKey = fieldPlaceholder.parsedFieldName.isAutoGenerated ?
            mergedKvPairKeys.autoGeneratedKey :
            mergedKvPairKeys.userGeneratedKey;

        const nestedFields = fields[mergedKvPairKey];
    ...
    const nestedValue = getNestedJsonValue(fields, fieldPlaceholder.fieldNameKeys);
